...
//製作明細
			...
			if(psDTO != null) psDTO.setVector(1, productData);
...
//売上明細
			...
			if(psDTO != null) psDTO.setVector(2, deliveryData);
...
//売伝一覧
			...
			if(psDTO != null) psDTO.setVector(3, slipListData);
			...
			if(productID > 0) {
				...
				if(psDTO != null) psDTO.setEsts(ests);
