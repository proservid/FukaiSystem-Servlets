			...
			if(isDel) {
				...
				try {
					if(cd.equals("0") || cd == null) {//新規追加
						ps = c.prepareStatement("INSERT INTO M_個人" +
						...
						if(indDTO.getBool(3)) {
							ps = c.prepareStatement("INSERT INTO M_個人住所" +
									" VALUES( ?, ?, ?, ?, ?, ?)");
							int j = 1;
							ps.setString(j++, cd);
						...
						ps = c.prepareStatement("UPDATE M_個人 SET" +
						...
						if(indDTO.getBool(3)) {
							//個人住所あり
							System.out.println("あり");System.out.println(indDTO.getStr(5));
							ps = c.prepareStatement(
