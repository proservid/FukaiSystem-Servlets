		...
		try {
			...
			try {
				...
				ps = c.prepareStatement("" +
					"SELECT CASE WHEN 所属部署CD IN(2,3,4) THEN RIGHT('00' + CONVERT(varchar, CD), 2) ELSE CONVERT(varchar, CD) END AS 個人CD,姓+' '+名 AS 氏名,RIGHT('00' + CONVERT(varchar, 所属部署CD), 2) AS 部署CD" +
