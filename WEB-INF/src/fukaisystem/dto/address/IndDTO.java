...
package fukaisystem.dto.address;
 ...
 * @author kameura
 */
public class IndDTO implements Serializable {
	...
	public IndDTO(
		String name, String name2, String dept, String post, String corpCD,
	...
	public String getStr(int order) {
		String s = "";
		switch(order) {
			case  0: s = name; break; //氏名
			case  1: s = name2; break; //シメイ
			case  2: s = dept; break; //所属部署
			case  3: s = post; break; //役職名
			case  4: s = corpCD; break; //会社コード
